...
> [!important]
> Project folder index. Main detail note: [[PKK App]]. Update this README when status, source path, deployment, or high-level direction changes.
...
See [[Projects/PKK App/techstack]] for detailed libraries and versions.
...
- [ ] Review main project note [[PKK App]]
...
- See [[PKK App]] for project-specific gotchas and learnings.
